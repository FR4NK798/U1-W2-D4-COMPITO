...
function check3and7(numPos){
    ...
    if(numPos % 3 === 0){
        ...
        console.log("Il numero non è un multiplo di 3 o di 7")
    }
    // if(multiplo3 === true){
    //     console.log(`Il numero: ${numPos} è un multiplo di 3`)
...
function reverseString(stringForn){
    ...
    for(let i = 0; i < stringaLettere.lenght; i++){
        ...
        const arrayReverse =[]
        arrayReverse.push(stringaLettere)   //reverse
        arrayReverse.join()
        return arrayReverse
